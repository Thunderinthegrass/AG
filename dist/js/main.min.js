...
function mobileMenu() {
  let e = document.querySelector(".mobile-menu"),
    t = document.querySelector(".mobile-menu__btn"),
    n = document.querySelector(".mobile-menu__close-btn");
...
function viewAll() {
  const e = document.querySelector(".view-all"),
    t = document.querySelectorAll(".cases__slider-item");
...
!(function (e, t) {
      ...
      function (e, t) {
        b.fn[e] = function (n, i) {
          ...
          return (
            ...
            this.length > 1 &&
              (N[e] || b.uniqueSort(o), L.test(e) && o.reverse()),
            this.pushStack(o)
          );
        };
      }
    ...
    if (
      ...
      for (l = (a = b.map(ge(o, "script"), De)).length; u < p; u++)
        (c = o),
          ...
          n.call(e[u], c, u);
      if (l)
        for (d = a[a.length - 1].ownerDocument, b.map(a, Le), u = 0; u < l; u++)
          (c = a[u]),
            he.test(c.type || "") &&
  ...
  $(function () {
    $(".cases__slider").slick({
      ...
      dots: !0,
      prevArrow:
        '<img class="slider-arrows slider-arrows__left"src="img/slider-arrows/arrow-left.svg" alt="">',
      nextArrow:
        '<img class="slider-arrows slider-arrows__right"src="img/slider-arrows/arrow-right.svg" alt="">',
      responsive: [{ breakpoint: 660, settings: "unslick" }],
    });
  });
